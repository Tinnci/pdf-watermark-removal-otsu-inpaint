...
def debug_detector_internals():
    ...
    if protect_text:
        ...
        print(f"  Text pixels removed: {np.count_nonzero(raw_mask) - np.count_nonzero(protected_mask)}")
    else:
...
def test_text_extraction():
    ...
    for thresh in thresholds:
        ...
        print(f"Threshold {thresh:3d}: Total={text_pixels:5d}, TextArea={area_pixels:4d}")
...
if __name__ == "__main__":
    ...
    print(f"Text protection working: {'NO' if actual_text_pixels > 1000 else 'PARTIAL'}")